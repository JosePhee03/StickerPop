    ...
    <footer className="w-full h-40 flex items-center justify-center bg-footer-gradient">
      <div className="flex flex-col items-center gap-3">
        ...
        <div className="flex items-center divide-x-2 divide-gray-300">
          <a className="cursor-pointer px-3" href="https://cloudinary.com/"><img src="/cloudinary.png" alt="cludinary logo" /></a>
          <a className="cursor-pointer px-3" href="https://midu.dev/"><img src="/midudev.png" alt="minudev logo" /></a>
        </div>
        <a
